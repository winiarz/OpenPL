...
#define RECORD_SIMSTEP_NOARG_DEC( simstepName ) \
    static std::vector<std::shared_ptr<InsPr::IGlobalArrayVariable>> RECORD_SIMSTEP_NOARG_NAME( simstepName ) ();


#define RECORD_SIMSTEP_NOARG_IMP0( className, simstepName ) \
    std::vector<std::shared_ptr<InsPr::IGlobalArrayVariable>> className :: RECORD_SIMSTEP_NOARG_NAME( simstepName ) () \
    {\
...
#define RECORD_SIMSTEP_NOARG_IMP1( className, simstepName, arg1Type ) \
    ...
    {\
        std::vector<std::shared_ptr<InsPr::IGlobalArrayVariable>> arguments; \
        std::shared_ptr<InsPr:: arg1Type ## Global> arg_1 = std::make_shared<InsPr:: arg1Type ## Global> ( ); \
...
#define RECORD_SIMSTEP_NOARG_IMP2( className, simstepName, arg1Type, arg2Type ) \
    ...
    {\
        std::vector<std::shared_ptr<InsPr::IGlobalArrayVariable>> arguments; \
        std::shared_ptr<InsPr:: arg1Type ## Global> arg_1 = std::make_shared<InsPr:: arg1Type ## Global> ( ); \
        std::shared_ptr<InsPr:: arg2Type ## Global> arg_2 = std::make_shared<InsPr:: arg2Type ## Global> ( ); \
        arguments.push_back( arg_1 ); \
