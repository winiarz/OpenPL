...
public:
    ...
    boost::shared_ptr<ClKernelPerformanceComparatorMock> performanceComparatorMock1;
    boost::shared_ptr<ClKernelPerformanceComparatorMock> performanceComparatorMock2;
