...
ClPlatformInclude= -I$(ClPlatform)/Include -I$(ClPlatform)/Interface
...
CommonInclude= -I$(Common)/Include
...
AllInclude=$(ClPlatformInclude) $(SimulationInclude) $(CommonInclude) $(KernelLoaderInclude) $(MockIncludes)
