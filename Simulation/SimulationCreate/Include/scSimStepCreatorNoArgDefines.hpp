...
#define RECORD_SIMSTEP_NOARG_DEC( simstepName ) \
    static std::vector<shared_ptr<OPL::InsPr::IGlobalArrayVariable>> RECORD_SIMSTEP_NOARG_NAME( simstepName ) ();


#define RECORD_SIMSTEP_NOARG_IMP0( className, simstepName ) \
    std::vector<shared_ptr<OPL::InsPr::IGlobalArrayVariable>> className :: RECORD_SIMSTEP_NOARG_NAME( simstepName ) () \
    {\
        std::vector<shared_ptr<OPL::InsPr::IGlobalArrayVariable>> arguments; \
...
#define RECORD_SIMSTEP_NOARG_IMP1( className, simstepName, arg1Type ) \
    ...
    {\
        std::vector<shared_ptr<OPL::InsPr::IGlobalArrayVariable>> arguments; \
        shared_ptr<OPL::InsPr:: arg1Type ## Global> arg_1 = make_shared<OPL::InsPr:: arg1Type ## Global> ( ); \
...
#define RECORD_SIMSTEP_NOARG_IMP2( className, simstepName, arg1Type, arg2Type ) \
    ...
    {\
        std::vector<shared_ptr<OPL::InsPr::IGlobalArrayVariable>> arguments; \
        shared_ptr<OPL::InsPr:: arg1Type ## Global> arg_1 = make_shared<OPL::InsPr:: arg1Type ## Global> ( ); \
        shared_ptr<OPL::InsPr:: arg2Type ## Global> arg_2 = make_shared<OPL::InsPr:: arg2Type ## Global> ( ); \
        arguments.push_back( arg_1 ); \
